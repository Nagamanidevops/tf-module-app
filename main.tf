    ...
    "Statement": [
        {
           ...
           # "arn:aws:ssm:us-east-1:633788536644:parameter/${var.env}.docdb*"
            ...
            "arn:aws:ssm:us-east-1:998626143474:parameter/${var.env}.ssh*",
...
resource "aws_lb_listener_rule" "backend_rule" {
  ...
  condition {
    host_header {
      values = ["${var.component}-${var.env}.devopsg70.online"]
    }
  }
}
...
resource "aws_lb_listener" "frontend" {
  ...
  certificate_arn   = "arn:aws:acm:us-east-1:998626143474:certificate/fd301b9e-21fd-498b-a5b2-c32d641801ed"
